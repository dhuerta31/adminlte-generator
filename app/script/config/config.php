...
$config["script_url"] = "http://localhost/backend/app/";
/************************ database ************************/
//Set the host name to connect for database
$config["hostname"] =  "localhost:3308";
//Set the database name
$config["database"] = "prueba";
...
$config["purchase_code"] = "0bf157c0-3df7-4f66-9672-3262e0a8907a";
