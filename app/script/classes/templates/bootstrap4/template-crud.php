        ...
        <div class="page-title clearfix card-header pdocrud-table-heading">
            ...
            <?php if ($settings["addbtn"]) { ?>
                <div class="btn-group float-right">
                    <a title="<?php echo $lang["add"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-add green btn btn-success btn-sm" href="javascript:;" data-action="add" data-obj-key="<?php echo $objKey; ?>">
            ...
            <?php if ($settings["savebtn"]) { ?>
                <div class="btn-group float-right">
                    <a title="<?php echo $lang["save"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-save green btn-success btn-sm mr-2" href="javascript:;" data-action="save_crud_table_data" data-obj-key="<?php echo $objKey; ?>">
                        <i class="fa fa-plus-circle" aria-hidden="true"></i>
                        <?php echo $lang["save"]; ?>
                    </a>                    
                </div>
                    ...
                    <div class="row pdocrud-search">
                        ...
                        <?php if ($settings["deleteMultipleBtn"]) { ?>
                            <div class="col-md-1 col-sm-1 col-xs-1 no-padding">
                                <a title="<?php echo $lang["delete_selected"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-delete-all green btn btn-danger btn-sm" href="javascript:;" data-action="delete_selected" data-obj-key="<?php echo $objKey; ?>">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <ul class="pdocrud-export-options">
                            <?php if ($settings["printBtn"]) { ?>
                                <li class="btn btn-outline-dark btn-sm"><i class="fa fa-print"></i> <a title="<?php echo $lang["print"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-export" href="javascript:;" data-action="exporttable" data-export-type="print" data-objkey="<?php echo $objKey; ?>"><?php echo $lang["print"]; ?></a></li>
                            <?php
                            }
                            if ($settings["csvBtn"]) {
                                ?> 
                                <li class="btn btn-outline-dark btn-sm"><i class="fa fa-file-excel-o"></i> <a title="<?php echo $lang["csv"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-export" href="javascript:;" data-action="exporttable" data-export-type="csv" data-objkey="<?php echo $objKey; ?>"><?php echo $lang["csv"]; ?></a></li>
                            <?php
                            }
                            if ($settings["pdfBtn"]) {
                                ?>
                                <li class="btn btn-outline-dark btn-sm"><i class="fa fa-file-pdf-o"></i> <a title="<?php echo $lang["pdf"]; ?>"class="pdocrud-actions pdocrud-button pdocrud-button-export" href="javascript:;" data-action="exporttable" data-export-type="pdf" data-objkey="<?php echo $objKey; ?>"> <?php echo $lang["pdf"]; ?></a></li>                            
                            <?php } if ($settings["excelBtn"]) { ?>
                                <li class="btn btn-outline-dark btn-sm"><i class="fa fa-file-excel-o"></i> <a title="<?php echo $lang["excel"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-export" href="javascript:;" data-action="exporttable" data-export-type="excel" data-objkey="<?php echo $objKey; ?>"><?php echo $lang["excel"]; ?></a></li>
                            <?php } ?>
                        </ul>
                    </div>
