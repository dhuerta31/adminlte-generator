                    ...
                    <div class="row pdocrud-search">
                        ...
                        <?php if ($settings["deleteMultipleBtn"]) { ?>
                            <div class="col-md-1 col-sm-1 col-xs-1 no-padding">
                                <a title="<?php echo $lang["delete_selected"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-delete-all btn btn-danger btn-sm" href="javascript:;" data-action="delete_selected" data-obj-key="<?php echo $objKey; ?>">
